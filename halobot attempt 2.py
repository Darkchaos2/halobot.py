...
class haloServer:
	def __init__(self, halo_voice_channel_id, halo_text_channel_id):
...
class Music:
	...
	async def play(self, ctx, *, song : str):
		...
		halo_servers[ctx.message.server] = haloServer(ctx.message.author.voice_channel.id, ctx.message.channel)
